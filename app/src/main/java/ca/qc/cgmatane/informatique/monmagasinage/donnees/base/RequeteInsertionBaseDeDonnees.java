...
public interface RequeteInsertionBaseDeDonnees {
    ...
    public final static String INSERT_COURSE_1=String.format("insert into %s (%s, %s, %s, %s) VALUES ('%s', '%s', '%s', %s)",
            Course.NOM_TABLE,  Course.CHAMP_NOM, Course.CHAMP_DATE_NOTIFICATION, Course.CHAMP_DATE_REALISATION, Course.CHAMP_ID_COURSE_ORIGINAL,  "Une course exeptionnelle", "2016-01-01-10:20", "2016-01-01-10:20", null);
